            ...
            foreach($row as $cell) {
                switch($cell) {
                    ...
                    case is_numeric($cell):
                        $html .= "<div class=\"cell cell--pc\"><input type=\"radio\" name=\"seat\" id=\"$room-$cell\" class=\"cell-radio\" value=\"$room-$cell\"/><label for=\"$room-$cell\" class=\"cell-label\">$cell</label></div>";
                        break;
                    case 'D':
